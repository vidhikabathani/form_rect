    ...
    const user_data = (e) => {
        ...
        if (isValid) {
            const updatedForms = forms.map((form, index) => ({
                ...form,
                id: all_users.length + index
            }));

            const updatedUsers = [...all_users, ...updatedForms];
    ...
    return (
        <div className="font-mono text-center my-20">
            <div className="flex justify-evenly">
                ...
                <button onClick={addForm} className="bg-slate-800 h-1/2 text-white px-4 py-2">+</button>
            </div>
                    ...
                    <div className="lg:w-1/4 sm:w-1/2 w-full p-7 sm:p-0 space-y-6 mx-auto mb-10">
                        ...
                        <div className="relative">
                            <input
                                type="text"
                                name="name"
                                className="w-full py-2 sm:m-0 border-b-2 border-slate-800 focus:outline-none"
                                placeholder="Enter Username"
                                value={form.name}
                                onChange={(e) => inputChange(form.id, e)}
                            />
